...
public class Admin_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(""), "Admin Login", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24))); // NOI18N
        ...
        jPanel4.setBounds(420, 190, 550, 460);
        ...
        try{
            ...
            while(rs.next()){
                if(userid.getText().equals(rs.getString(1))&& pass.getText().equals(rs.getString(9))){
                 PreparedStatement ps1=con.prepareStatement("SELECT COUNT(*) AS row_count FROM student");
            ResultSet rs1=ps1.executeQuery();
            rs1.next();
            int no_stu=rs1.getInt("ROW_COUNT");
                admin_dashboard ad=new admin_dashboard(userid.getText(), no_stu);
                ad.noofstudent.setText(String.valueOf(no_stu));
                ad.setVisible(true);
    ...
    private void reginowMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_reginowMouseClicked
        Admin_Register sr=new Admin_Register();
        sr.setVisible(true);
        this.setVisible(false);
