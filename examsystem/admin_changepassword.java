...
public class admin_changepassword extends javax.swing.JFrame {
     ...
     * @param user
     */
    public admin_changepassword(String user) {
        initComponents();
         this.user1=user;
    }
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Change Password", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24))); // NOI18N
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try{
            ...
            PreparedStatement ps=con.prepareStatement("select * from admin WHERE First_name=?");
            ...
            if(rs.next()){
                ...
                PreparedStatement ps1=con.prepareStatement("update admin set PASSWORD=? WHERE password=?");
